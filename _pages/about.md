...
<div class="research-areas">
  ...
  <section class="research-area">
    ...
    <p>I build systems software on trusted hardware to protect sensitive applications and data, including library OSes, secure storage, enclave services, and confidential-computing platforms. I contributed to <a href="https://github.com/occlum/occlum">Occlum</a>, an SGX library OS deployed in Alipay, and <a href="https://asterinas.github.io/">Asterinas</a>, a Rust-based, Linux-compatible OS. I also developed a secure, resource-efficient Kubernetes architecture for multi-tenancy [EuroSys 26]. My work covers sync-atomic storage against SGX-PFS eviction attacks [FAST 25], in-enclave policy verification and user isolation [DSN 21, TDSC 23], and privacy-preserving analytics and enclave-assisted computation [CLOUD 21, CHES 26].</p>
  </section>

  <section class="research-area">
    <h3><span class="research-area-number">03</span> Processor and Microarchitectural Security</h3>
    <p>I investigate microarchitectural attacks and hardware-assisted defenses. My work covers VMFUNC-based time blurring <span class="paper-ref">[ESORICS 17]</span>, virtualization-based controlled-channel detection <span class="paper-ref">[ICA3PP 18]</span>, hardware-event-based covert-channel detection <span class="paper-ref">[SCN 16]</span>, hardware atomization for defending against preemption attacks <span class="paper-ref">[ISPA 20]</span>, LBR-assisted virtual machine introspection <span class="paper-ref">[TIFS 22]</span>, and Rowhammer attacks <span class="paper-ref">[Tsinghua ST 19]</span>.</p>
  </section>
</div>
